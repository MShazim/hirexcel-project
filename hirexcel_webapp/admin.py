...
class DiscScoreCalculationDatasetAdmin(admin.ModelAdmin):
    list_display = ('DISC_PROFILE_SCORE_ID', 'D', 'I', 'S', 'C')
...
class BigFiveAssessmentResultAdmin(admin.ModelAdmin):
    list_display = ('BIGFIVE_ASSESSMENT_RESULT_ID', 'BIGFIVE_ASSESSMENT_ID', 'DIMENSION', 'OPENNESS_SCORE', 'CONCIENTIOUSNESS_SCORE', 'EXTRAVERSION_SCORE', 'AGREEABLENESS_SCORE', 'NEUROTICISM_SCORE', 'TOTAL_BIGFIVE_COMPLETION_TIME')

class PersonalityAssessmentReportAdmin(admin.ModelAdmin):
    list_display = ('PERSONALITY_ASSESSMENT_REPORT_ID', 'PERSONALITY_ASSESSMENT_ID', 'JOB_SEEKER_ASSESSMENT_ID', 'BIGFIVE_ASSESSMENT_ID', 'DISC_ASSESSMENT_ID', 'DISC_CATEGORY', 'DISC_PERSONALITY_TRAIT', 'DISC_COGNITIVE_ABILITY', 'DISC_EMOTIONAL_REGULATION', 'DISC_TENDENCIES', 'DISC_WEAKNESSES', 'DISC_BEHAVIOUR', 'DISC_MOTIVATED_BY', 
...
class CognitiveAssessmentResultsAdmin(admin.ModelAdmin):
    list_display = ('COGNITIVE_ASSESSMENT_RESULT_ID', 'COGNITIVE_ASSESSMENT_ID', 'COGNITIVE_VI_SCORE', 'COGNITIVE_NVI_SCORE' ,'TOTAL_COGNITIVE_SCORE','COGNITIVE_SCORE_PERCENTAGE', 'VI_COMPLETION_TIME', 'NVI_COMPLETION_TIME', 'TOTAL_COGNITIVE_COMPLETION_TIME')
...
class TechnicalAssessmentResultAdmin(admin.ModelAdmin):
    list_display = ('TECHNICAL_ASSESSMENT_RESULT_ID', 'TECHNICAL_ASSESSMENT_ID', 'TOTAL_TECH_SCORE', 'TECH_SCORE_PERCENTAGE', 'TOTAL_TECHNICAL_COMPLETION_TIME')
