...
class Evaluation_Summary(models.Model):
    ...
    JOB_POST_ID = models.ForeignKey(Job_Posting, on_delete=models.CASCADE)
    ASSESSMENT_ID = models.ForeignKey(Assessment, on_delete=models.CASCADE)
    PERSONALITY_ASSESSMENT_REPORT_ID = models.ForeignKey(Personality_Assessment_Report, on_delete=models.CASCADE)
    COGNITIVE_ASSESSMENT_RESULT_ID = models.ForeignKey(Cognitive_Assessment_Results, on_delete=models.CASCADE)
    TECHNICAL_ASSESSMENT_RESULT_ID = models.ForeignKey(Technical_Assessment_Result, on_delete=models.CASCADE)
